      ...
      >
        ...
        <div style={{ padding: '20px' }}>
          ...
          >
            ...
            <p style={{ fontSize: '14px', color: THEME.text, margin: 0, fontWeight: 500 }}>
              {originalPost.title}
            </p>
            {originalPost.shortDescription && (
              <p style={{ fontSize: '12px', color: THEME.textMuted, margin: '4px 0 0', lineHeight: 1.4 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '10px' }}>
                {hashtags.map((tag) => (
                  <Chip
                    key={tag}
                    label={`#${tag}`}
                    onDelete={isLoading ? undefined : () => handleRemoveHashtag(tag)}
                    sx={{
