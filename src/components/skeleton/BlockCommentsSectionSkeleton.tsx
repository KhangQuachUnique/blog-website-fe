...
const BlockCommentsSectionSkeleton: React.FC = () => {
  return (
    <Box sx={{ width: "100%" }}>
      ...
      {/* Comment input */}
      <Box sx={{ mb: 3 }}>
        <Skeleton variant="rectangular" width="100%" height={96} animation="wave" sx={{ borderRadius: 2 }} />
            ...
            <Stack direction="row" spacing={2} alignItems="flex-start">
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Stack spacing={0.75} sx={{ mb: 1 }}>
                  <Skeleton variant="text" width={`${100 - idx * 8}%`} height={16} animation="wave" />
                  <Skeleton variant="text" width={`${82 - idx * 6}%`} height={16} animation="wave" />
                </Stack>

                {/* reply preview (nested) */}
                <Box sx={{ mt: 1, borderRadius: 1, bgcolor: "background.paper", border: "1px solid", borderColor: "divider", p: 2 }}>
