      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="col-span-1 lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#FFE4EC]">
                <h3 className="text-lg font-bold text-[#8C1D35] mb-4 pb-2 border-b border-gray-100">Thông tin liên hệ</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center gap-3 p-3 bg-[#FAF5F7] rounded-xl">
                        <div className="p-2 bg-white rounded-lg text-[#F295B6] shadow-sm"><FiMail fontSize={20} /></div>
                        <div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-[#FAF5F7] rounded-xl">
                        <div className="p-2 bg-white rounded-lg text-[#F295B6] shadow-sm"><FiPhone fontSize={20} /></div>
                        <div>
                            <p className="text-xs text-gray-500">Số điện thoại</p>
                            <p className="font-medium text-gray-700">{user.phoneNumber || "Chưa cập nhật"}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#FFE4EC]">
                <h3 className="text-lg font-bold text-[#8C1D35] mb-4 pb-2 border-b border-gray-100">Thông tin hệ thống</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
